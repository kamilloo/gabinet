            ...
            <nav class="xs_nav_2 xs_nav-landscape">
                ...
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu nav-menu-centered">
                        ...
                        <li><a href="#">blog</a>
                            <ul class="nav-dropdown">
                                <li><a href="blog.html">blog version 1</a>
                                </li>
                                <li><a href="blog-v2.html">blog version 2</a>
                                </li>
                        ...
                        <li><a href="#">element</a>
                            <div class="megamenu-panel">
                                ...
                                <div class="megamenu-lists">
                                    ...
                                    <ul class="megamenu-list list-col-4">
                                        <li class="megamenu-list-title"><a href="#">image</a></li>
                        ...
                        <div class="beautypress-service-and-date">
                            ...
                            <div class="beautypress-spilit-container">
                                <div class="beautypress-date-select beautypress-select">
                                    <div class="input-group">
                                        <input type="text" id="appointment-date" class="form-control datepicker" name="appointment-date" placeholder="Date Shedule">
                                    </div>
...
<section class="beautypress-call-to-action-section beautypress-bg parallax-bg" data-parallax="scroll" data-image-src="img/call-to-action.jpg">
    <div class="container">
        <div class="beautypress-call-to-action-content beautypress-version-2">
            ...
            <a href="#" class="xs-btn round-btn box-shadow-btn bg-chocolate">get appointment <span></span></a>
...
<!-- Exclusive products -->
<section class="beautypress-exclusive-products beautypress-padding-bottom">
    <div class="container">
        <div class="beautypress-section-headinig beautypress-version-2">
            <h2>We are awesome</h2>
            <h3>Our Products</h3>
            ...
            <div class="col-md-6 col-sm-12 col-lg-3 col-xl-3">
                <div class="beautypress-product-group">
                    ...
                    <div class="beautypress-product-hover-elements">
                        <a href="#" class="beautypress-iocn-btn pulse-btn full-round-btn bg-color-cyan">
                            <i class="fa fa-heart-o"></i>
                        </a>
                        <a href="#" class="beautypress-iocn-btn full-round-btn bg-color-cyan">
                            <i class="fa fa-shopping-basket"></i>
                        </a>
                    </div><!-- .beautypress-product-hover-elements END -->
...
<!-- Fun factory section -->
<section class="beautypress-fun-factory-section bg-color-cyan">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-lg-3 col-xl-3">
                <div class="beautypress-single-fun-factory">
                    ...
                    <div class="beautypress-counter">
                        <h2 class="numeric-count number-animate" data-value="10" data-animation-duration="3200">0</h2>
                        <span>+</span>
                    </div>
                    <h5>Specialist</h5>
            ...
            <div class="col-md-6 col-sm-12 col-lg-3 col-xl-3">
                <div class="beautypress-single-fun-factory">
                    ...
                    <div class="beautypress-counter">
                        <h2 class="numeric-count number-animate" data-value="4000" data-animation-duration="3200">0</h2>
                        <span>+</span>
                    </div>
                    <h5>Happy Users</h5>
                </div><!-- .beautypress-single-fun-factory END -->
            ...
            <div class="col-md-6 col-sm-12 col-lg-3 col-xl-3">
                <div class="beautypress-single-fun-factory">
                    ...
                    <div class="beautypress-counter">
                        <h2 class="numeric-count number-animate" data-value="70" data-animation-duration="3200">0</h2>
                        <span>+</span>
                    </div>
            ...
            <div class="col-md-6 col-sm-12 col-lg-3 col-xl-3">
                <div class="beautypress-single-fun-factory">
                    ...
                    <div class="beautypress-counter">
                        <h2 class="numeric-count number-animate" data-value="100" data-animation-duration="3200">0</h2>
                        <span>+</span>
                    </div>
                    <h5>Services</h5>
                </div><!-- .beautypress-single-fun-factory END -->
...
</section><!-- .beautypress-fun-factory-section END -->
<!-- Fun factory section -->
    ...
    <div class="beautypress-copyright-content">
        <div class="container">
            <div class="beautypress-copyright-text">
                <p><a href="https://xpeedstudio.com" class="color-purple">XpeedStudio</a> &copy; 2017 All Rights Reserved.</p>
            </div>
        </div>
    </div>
